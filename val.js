$(document).ready(function() {
    ...
    $("#password").keyup(function() {
        if (validatepass4()) {
            ...
            $("#messagepass").html("<p class='text-danger'>ENTER A SPECIAL CHARACTER </p>")
        } else if (validatepass5()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER A NUMBER</p>")
        } else if (validatepass7()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER A SMALLER CHARACTER</p>")
        } else if (validatepass9()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER a UPPERCASE CHARACTER</p>")
        } else if (validatepass6()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER UPPERCASE AND SPECIAL CHARACTER</p>")
        } else if (validatepass8()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER length more than 8</p>")
        } else if (validatepass3()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER NUMBER+Special Character </p>")
        } else if (validatepass2()) {
            $("#password").css("border", "4px solid red");
            $("#messagepass").html("<p class='text-danger'>ENTER NUMBER+UPPERCASE+Special Character </p>")
        } else {
            $("#password").css("border", "4px solid red");
...
function buttonstate() {
    ...
    if (validatename() && validateemail() && validatephone() && validateage() && username() && validatepass4()) {
        $("#submit").show();
    } else {
        $("#submit").hide();
    }
...
function validatepass() {
    ...
    var strong = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])[a-zA-z0-9]{8,20}$/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
function validatepass6() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[a-z])(?=.*[0-9])(?=.{8,20})[a-z0-9]{8,20}$/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
function validatepass3() {
    ...
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[a-z])(?=.*[A-Z])[a-zA-z]{8,20}$/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
//^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})
function validatepass4() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
//^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#\$%\^&\*])(?=.{8,20})[a-zA-z!@#$%^&*]{8,20}$
function validatepass5() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#\$%\^&\*])(?=.{8,20})[a-zA-z!@#$%^&*]{8,20}$/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
//^(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})
function validatepass7() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
function validatepass8() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^[a-zA-z0-9]{0,7}$/;
    if (strong.test(pass)) {
        return true;
    } else {
        return false;
...
//^(?=.*[a-z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})[a-z0-9!@#$%^&*]{8,20}$
function validatepass9() {
    //special charcter between characters 
    //(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[a-zA-z][!@#$%^&*?][a-zA-z])(?=.*[~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?])[a-zA-z0-9~`!@#$%^&*()-_+={}[|\;:"<\]\>,./?]{8,20}
    var pass = $("#password").val();
    var strong = /^(?=.*[a-z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,20})[a-z0-9!@#$%^&*]{8,20}$/;
